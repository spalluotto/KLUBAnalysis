                        ...
                        for badfile in badfiles_list:
                            ...
                            if "output_" in filename and filename.endswith(".root"):
                                ...
                                if partition_number.isdigit():
                                    ...
                                    print("condor sample name",condor_sample_name)
                                    condor_sample_path = os.path.join(condor_dir, f"SKIM_{condor_sample_name}")
                                    print("condor sample path",condor_sample_path)
