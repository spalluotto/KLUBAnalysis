...
request_memory = 2900
Requirements = ((machine == \"pccms02.hcms.it\") || (machine == \"pccms02.hcms.it\") || (machine == \"pccms03.hcms.it\") || (machine == \"pccms04.hcms.it\") || (machine == \"clipper.hcms.it\") || (machine == \"empire.hcms.it\"))
"""
        if args.with_dnn:
            condor_content += """
