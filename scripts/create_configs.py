...
class Params:
    ...
    def define_nondnn_binning(self):
        bin_map = {
        	...
        	"HH_deltaR"                         : [35, 0, 7],
            "fatjet_softdropMass"               : [10, 0, 300],
            "fatjet_pt"                         : [10, 250, 700],
            "fatjet_eta"                        : [10, -2.5, 2.5 ],
            "fatjet_phi"                        : [10, -3.14159, 3.14159],
            "fatjet_particleNetMDJetTags_score" : [10, 0.0, 1.05],
            "fatjet_particleNetMDJetTags_mass"  : [10, 0, 250],
