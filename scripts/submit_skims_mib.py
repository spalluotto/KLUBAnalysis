...
if year == '2016preVFP':
    ...
    inputDir_sig    = f'{klubDir}/inputFiles/UL16_Signals'
    inputDir_data   = f'{klubDir}/inputFiles/UL16_Data'

    puDir           = '%s/weights/PUreweight/UL_Run2_PU_SF/2016/PU_UL2016_SF.txt'%klubDir
else:
    sys.exit("invalid period")
# ---------------------------------------
...
# BASE COMMAND ---  
# -T: folder tag name    -s: sleep in submission      -c: skim config file    --period: year    -k: run HH kin fitter    -q: batch queue
...
names = {
    ...
    "SingleElectron__Run2016F" : "EGammaF",
    "SingleElectron__Run2016G" : "EGammaG",
    "SingleElectron__Run2016H" : "EGammaH",
    "Tau__Run2016F" : "TauF",
    "Tau__Run2016G" : "TauG",
    "Tau__Run2016H" : "TauH",
    "SingleMuon__Run2016F" : "MuonF",
    "SingleMuon__Run2016G" : "MuonG",
    "SingleMuon__Run2016H" : "MuonH",
    "MET__Run2016F" : "METF",
    "MET__Run2016G" : "METG",
    "MET__Run2016H" : "METH",
...
bkg_map = {
    ...
    "DYJetsToLL_2J"                                   : "-n 150 -x 342.96       -g True  --isDYlike",

    "DYJetsToLL_M-50"                                 : "-n 300 -x 6077.22      -g True  --isDYlike",
    ...
    "ZHToTauTau_M125"                     : "-n 50    -x 0.880    -y 0.06272 --isDYlike",
    "WplusHToTauTau_M125"                 : "-n 50    -x 0.831    -y 0.06272 --isDYlike",
    "WminusHToTauTau_M125"                : "-n 50    -x 0.527    -y 0.06272 --isDYlike",
    "GluGluHToTauTau_M125"                : "-n 50    -x 48.68    -y 0.06272 --isDYlike", # this should probably be -x 48.61
    "VBFHToTauTau_M125"                   : "-n 50    -x 3.766    -y 0.06272 --isDYlike",
...
if year == '2016preVFP':
    data_map = {
        ...
        "MET__Run2016D" :  "-n 100    -d True   --datasetType 1",
        "MET__Run2016E" :  "-n 100    -d True   --datasetType 1",
        "MET__Run2016F" :  "-n 100    -d True   --datasetType 1"
    }    
elif year == '2016postVFP':
    data_map = {
        "SingleElectron__Run2016F" :  "-n 100    -d True",
        "SingleElectron__Run2016G" :  "-n 100    -d True",
        "SingleElectron__Run2016H" :  "-n 100    -d True",

        "Tau__Run2016F" :  "-n 100    -d True  --datasetType 2",
        "Tau__Run2016G" :  "-n 100    -d True  --datasetType 2",
        "Tau__Run2016H" :  "-n 100    -d True  --datasetType 2",

        "SingleMuon__Run2016F" :  "-n 100    -d True",
        "SingleMuon__Run2016G" :  "-n 100    -d True",
        "SingleMuon__Run2016H" :  "-n 100    -d True",

        "MET__Run2016F" :  "-n 100    -d True   --datasetType 1",
        "MET__Run2016G" :  "-n 100    -d True   --datasetType 1",
        "MET__Run2016H" :  "-n 100    -d True   --datasetType 1",
