...
std::shared_ptr<Sample> AnalysisHelper::openSample(std::string sampleName)
{
  ...
  std::shared_ptr<Sample> sample(new Sample(sampleName, filenames, "HTauTauTree", sampleCfg_->readStringOpt(Form("evaluation::tree")), sampleCfg_->readStringOpt(Form("samples::base")), sampleCfg_->readStringOpt(Form("evaluation::base")), "h_eff", 1));
